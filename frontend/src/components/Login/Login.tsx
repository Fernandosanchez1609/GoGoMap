          ...
          <form onSubmit={handleSubmit} className="flex flex-col gap-5">
            <div className="flex flex-col gap-2">
              ...
              <Input
                ...
                className={`h-14 rounded-xl bg-white ${errors.usuario ? "border-red-500" : "border-gray-300"}`}
              />
            ...
            <div className="flex flex-col gap-2">
              ...
              <Input
                ...
                className={`h-14 rounded-xl bg-white ${errors.password ? "border-red-500" : "border-gray-300"}`}
              />
